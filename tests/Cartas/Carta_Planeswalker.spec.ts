...
describe('Cartas de Planeswalker Class', () => {
    const cartaPlaneswalker = new Cartas_Planeswalker(1, 'Planeswalker de Prueba', 5, 'azul', 'Planeswalker', 'rara', 'Texto de prueba', 15, 4);


    it('Crea sus inistacias y sus gets correctamnete', () => {
        expect(cartaPlaneswalker).to.be.instanceOf(Cartas_Planeswalker);
